...
<!-- START BODY -->
<body class="no_js responsive {{(Route::currentRouteName() == 'permissions.index') || (Route::currentRouteName() == 'users.index') || (Route::currentRouteName() == 'menus.index')|| (Route::currentRouteName() == 'admin.articles.index')|| (Route::currentRouteName() == 'index') ? 'page-template-home-php' : '' }} stretched">
